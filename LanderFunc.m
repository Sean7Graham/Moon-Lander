function[Am,Vend,Mend] = LanderFunc(test)
%LanderFunc
%Automated Investigation of piecewise linear models
...
%defines the gain of the control system
gain = 1000;

% Define three co-ordinates for the lines to go through
Hpoints = test.hpoints;  % In vector form X = [x1 x2 x3]
Vpoints = test.vpoints;  % and Y = [y1 y2 y3]
